...
1. In **Appearance → Menus** [create a classic menu](https://codex.wordpress.org/WordPress_Menu_User_Guide) and assign it to a desired menu display location, such as "Primary" location.
2. Navigate to **Appearance → Editor → Patterns → All Template Parts** and edit the [template part](https://wordpress.org/documentation/article/site-editor/#to-manage-the-template-parts) that displays your navigation – most likely it is a "Header" template part.
3. In the template part content find the [**Navigation** block](https://wordpress.org/documentation/article/navigation-block/) (you may use a [list view](https://wordpress.org/documentation/article/site-editor/#list-view) for this) and edit the block options to display the "Primary" menu location (the menu location you've set in step #1).
4. Save your changes and preview the results on the front-end of your website. Your Navigation block now displays your classic menu.
